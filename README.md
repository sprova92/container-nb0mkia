...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-nb0mkia.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-nb0mkia.containers.anotherwebservice.com/
...
```
git clone git@github.com:sprova92/container-nb0mkia.git
cd container-nb0mkia
```
...
```
docker attach container-nb0mkia
```
